    ...
    return {
        ...
        init: function () {
			function deleteRow(oTable, nRow){
				...
				//$.ajax({
				//type:"DELETE",
				//url:"/support/cluster/freeswitch",
				//dataType:"json",
				//contentType:"application/json",
				//data:JSON.stringify({"container_id":aData[0],"host":aData[1],"port":aData[2],"status":aData[3],"tenant":aData[4],"assigned_time":aData[5],"active_time":aData[6],"freeswitch_type":aData[7]}),
